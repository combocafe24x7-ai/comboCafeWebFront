                           ...
                           {orderMethod === 'whatsapp' ? (
                            <>
                                ...
                                <DialogFooter className="px-6 pb-6 pt-4 border-t bg-background absolute bottom-0 left-0 right-0 sm:relative">
                                    {paymentMethod === 'prepaid' ? (
                                        <Button type="submit" form={`form-collection-${cardId}`} className="w-full" size="lg" disabled={!transactionId || transactionId.length < 12 || (deliveryMethod === 'home-delivery' && !isAddressVerified)} suppressHydrationWarning>
                                            I have paid - Place Order on WhatsApp
                                        </Button>
                                    ) : (
                                        <Button type="submit" form={`form-collection-${cardId}`} className="w-full" size="lg" disabled={(deliveryMethod === 'home-delivery' && !isAddressVerified)} suppressHydrationWarning>
