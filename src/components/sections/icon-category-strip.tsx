  ...
  return (
    <section className="py-8">
        <div className="container mx-auto">
            <div className="flex items-start justify-start gap-x-2 md:gap-x-4 lg:gap-x-6 overflow-x-auto scrollbar-hide">
                ...
                >
                    <div className="relative w-20 h-20 rounded-2xl bg-card flex items-center justify-center shadow-subtle border border-black/5 transition-all duration-300 group-hover:shadow-card group-hover:border-primary/50 group-hover:-translate-y-1 overflow-hidden">
